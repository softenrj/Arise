            ...
            <View style={{ flex: 1, backgroundColor: BACKGROUND_COLOR, }} >
                <ScrollView className="flex-1" showsVerticalScrollIndicator={false} bounces >
                    <LinearGradient
                        ...
                        style={{ position: 'absolute', top: 0, left: 0, right: 0, height: screenHeight, opacity: 0.8, }}
                    />
                    ...
                    <SafeAreaView className="flex-1 px-6 mb-10">
                        <View style={{ minHeight: firstPageHeight }} className="justify-between">
                            ...
                            <View className="flex-1 items-center justify-center">
                                {track?.artwork ? (
                                    <Image source={{ uri: track.artwork }} className="w-full aspect-square rounded-md bg-white/5" resizeMode="cover" />
                                ) : (
